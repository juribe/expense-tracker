...
module Expenses
  module Inputs
    ...
    #
    # Every typed input is itself an Expenses::Input produced by
    ...
    # payloads). The canonical Expenses::Input holds no per-type
    ...
    class Base < Input
      ...
      class << self
        # Channel params -> typed Expenses::Input for the pipeline.
        ...
        # Expenses::Input delegates to, so the pipeline and the typed
