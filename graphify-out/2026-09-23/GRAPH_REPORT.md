...
## Corpus Check
- 451 files · ~214,203 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3233 nodes · 4065 edges · 371 communities (157 shown, 185 thin omitted)
...
## Communities (371 total, 185 thin omitted)
...
Cohesion: 0.17
Nodes (3): Ai, Ai::StatementExtractor, parse()
...
Cohesion: 0.05
Nodes (13): ExpenseCandidate, ExpenseCandidatesControllerTest, IntegrationTest, ExpenseCandidateTest, TestCase, ExpensePlayground, ExpensePlayground::DuplicateDetectorTest, TestCase (+5 more)
...
### Community 230 - "ExpenseResolver::MoneySourceResult"
Cohesion: 0.22
Nodes (3): ExpenseResolver, ExpenseResolver::MoneySourceResult, ExpenseResolver::MoneySourceResult::Result

### Community 231 - "Ocr::LocalReader"
Cohesion: 0.05
Nodes (19): Expenses, Expenses::Processors, Expenses::Processors::Audio, Base, Expenses::Processors::Audio, Expenses::Processors::Audio::Transcription, Expenses::Processors::Audio::Transcription::Result, Expenses (+11 more)
...
### Community 245 - "Ai::Tasks::TransactionExtraction"
Cohesion: 0.22
...
### Community 248 - "ExpenseResolver::DescriptionResult"
Cohesion: 0.25
...
### Community 256 - "ExpenseResolver::HeuristicResolver"
Cohesion: 0.29
...
### Community 280 - "Ai::TransactionExtractorTest"
Cohesion: 0.33
...
### Community 331 - "Ai::Tasks::StatementExtraction"
Cohesion: 0.20
...
### Community 341 - "Expenses::Processors::Text"
Cohesion: 0.27
...
### Community 356 - "Ai::CategoryClassifierTest"
Cohesion: 0.29
Nodes (3): Ai, Ai::CategoryClassifierTest, TestCase

### Community 360 - "Ai::StatementExtractorTest"
Cohesion: 0.40
...
- **Why does `ApplicationRecord` connect `ApplicationRecord` to `SourceRecognition::Catalog`, `MoneySource`, `.normalize_name`, `ExpensePlaygroundRun`, `RecurringTemplate`, `EvaluationRun`, `Category`, `EvaluationCase`, `FinancialSetup`, `AiRequest`, `MoneySourceRecognitionIdentifier`, `ProcessedEmail`, `Budget`, `Transfer`, `Transaction`, `Ai::Router`, `CreditAccount`, `ExpenseCandidate`, `TransactionRule`, `MoneySourceRecognition`, `User`, `FinancialCatalogSeeder`, `GmailConnection`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `Category` connect `Category` to `ExpensesController`, `.normalize_name`, `FinancialSetupsController`, `TransactionRulesController`, `RecurringTemplatesController`, `ExpensePlaygroundController`, `FinancialSetups::Completer`, `Expenses::Processors::Image::VisionCandidateBuilder`, `RecurringTemplateActions`, `ExpenseResolver::Service`, `Categories::HeuristicResolver`, `IncomesController`, `ApplicationRecord`, `ExpenseResolver::NaturalLanguageParser`, `Budget`, `ExpensePlayground::Evaluations::ResultBuilder`, `ExpenseCandidatesController`, `TransactionRules::SuggestionService`, `ExpenseEvaluationsController`, `Categories::ClosestResolver`, `Expenses::FileProcessor`, `User`, `.call`, `.build_expense_from_confirmed_input`, `Ai::CategoryClassifierTest`, `RecurringTemplateImporter`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `ExpenseCandidate` connect `ExpenseCandidate` to `Expenses::Processor`, `ApplicationRecord`, `ExpenseResolver::CandidateDetector`, `Expenses::FileProcessor`?**
