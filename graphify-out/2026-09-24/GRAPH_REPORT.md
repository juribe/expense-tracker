# Graph Report - expense-tracker  (2026-09-23)

## Corpus Check
- 452 files · ~215,419 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3239 nodes · 4073 edges · 375 communities (159 shown, 187 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7dad89de`
...
## Communities (375 total, 187 thin omitted)
...
### Community 36 - "SourceRecognition::SuggestionEngine"
Cohesion: 0.17
...
### Community 230 - ".stub_method"
Cohesion: 0.22
Nodes (3): Ai::Router::Result, ExpensePlaygroundControllerTest, IntegrationTest
...
Cohesion: 0.13
Nodes (6): Ai, ExpenseResolver, ExpenseResolver::ConfidenceGate, ExpenseResolver, ExpenseResolver::HeuristicResolver, ExpenseResolver::HeuristicResolver::Resolution
...
### Community 248 - "Expenses::Processors::Image"
Cohesion: 0.29
...
### Community 330 - "ApplicationController"
Cohesion: 0.17
Nodes (4): AlertSettingsController, ApplicationController, Base, MonthlyExpensesController

### Community 331 - "Expenses::Processors::Audio::Transcription"
Cohesion: 0.33
...
### Community 336 - "SpeechToText::Result"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (7): Ai, Ai::Tasks, Ai::Tasks::ParsedExpense, ExpensePlaygroundAudioControllerTest, IntegrationTest, ExpenseResolverServiceTest, TestCase

### Community 349 - "EmailTransactionDetectorTest"
Cohesion: 0.22
Nodes (4): EmailTransactionDetector, EmailTransactionDetector::Result, EmailTransactionDetectorTest, TestCase

### Community 352 - ".normalize_text"
Cohesion: 0.38
...
### Community 360 - "Expenses::CreateTest"
Cohesion: 0.40
...
### Community 367 - "Gmail::QueryBuilderTest"
Cohesion: 0.40
...
- **Why does `ApplicationRecord` connect `ApplicationRecord` to `SourceRecognition::Catalog`, `MoneySource`, `.normalize_name`, `ExpensePlaygroundRun`, `RecurringTemplate`, `EvaluationRun`, `EvaluationCase`, `Category`, `FinancialSetup`, `AiRequest`, `MoneySourceRecognitionIdentifier`, `ProcessedEmail`, `Budget`, `Transfer`, `Transaction`, `Ai::Router`, `ExpenseCandidate`, `TransactionRule`, `MoneySourceRecognition`, `User`, `FinancialCatalogSeeder`, `GmailConnection`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `Category` connect `Category` to `ExpensesController`, `.normalize_name`, `FinancialSetupsController`, `TransactionRulesController`, `RecurringTemplatesController`, `ExpensePlaygroundController`, `FinancialSetups::Completer`, `Expenses::Processors::Image::VisionCandidateBuilder`, `RecurringTemplateActions`, `ExpenseResolver::Service`, `Categories::HeuristicResolver`, `IncomesController`, `Budget`, `ExpensePlayground::Evaluations::ResultBuilder`, `ExpenseCandidatesController`, `TransactionRules::SuggestionService`, `ExpenseEvaluationsController`, `Categories::ClosestResolver`, `ApplicationRecord`, `Expenses::FileProcessor`, `User`, `.call`, `.build_expense_from_confirmed_input`, `RecurringTemplateImporter`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `ExpenseCandidate` connect `ExpenseCandidate` to `Expenses::Processor`, `ApplicationRecord`, `ExpensePlayground::DuplicateDetectorTest`, `ExpensePlayground::EvaluationTest`, `Expenses::FileProcessor`, `ExpenseCandidatesControllerTest`, `ExpenseCandidateTest`, `ExpensePlaygroundEvaluationsResultBuilderTest`, `ExpenseResolver::CandidateDetector`?**
